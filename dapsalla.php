...
$sql = "SELECT * FROM vizag where rate='2,299'";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
   		...
   		echo "<center><table><tr><td width=200px height=200px><img src=".$row["img1"]."width=100%></td><td width=200px height=200px><img src=".$row["img2"]."width=10px></td><td width=200px height=200px><img src=".$row["img3"]."width=100%></td></tr>
